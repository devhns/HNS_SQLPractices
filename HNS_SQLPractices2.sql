-- Þirkette hala çalismaya devam eden çalisanlar
...
-- Pozisyon bazinda mevcut çalýþan sayisi ve ortalama maasin listelenmesi
...
-- baglý olduðu birim yöneticisinin adý ve yöneticinin pozisyonunu getiren kod
